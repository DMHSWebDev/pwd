document.addEventListener("DOMContentLoaded", function () {
    ...
    player1Btn.addEventListener('click', async function () {
        ...
        let player1CardVaule = document.getElementById('player1-value');
        player1CardVaule.innerText = player1card.value;
    ...
    player2Btn.addEventListener('click', async function () {
        ...
        let player2CardVaule = document.getElementById('player2-value');
        player2CardVaule.innerText = player2card.value;
